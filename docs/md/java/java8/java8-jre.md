...
> ![](images/java8-jre-1.png)

### # 使用工具开发的效果

> ![](images/java8-jre-2.png)
...
************** PROFILE ********************
jdeps -P Deps.class 
Deps.class -> /Library/Java/JavaVirtualMachines/jdkjdk/Contents/Home/jre/lib/rt.jar
   <unnamed> (Deps.class)
      -> java.io                                            compact1
      -> java.lang                                          compact1
      -> java.util                                          compact1
...
Deps.class -> /Library/Java/JavaVirtualMachines/jdkjdk/Contents/Home/jre/lib/rt.jar
   <unnamed> (Deps.class)
      ...
      -> java.lang                                          
      -> java.util                                          
/Library/Java/JavaVirtualMachines/jdkjdk/Contents/Home/jre/lib/jce.jar -> /Library/Java/JavaVirtualMachines/jdkjdk/Contents/Home/jre/lib/rt.jar
   ...
   javax.crypto.spec (jce.jar)
      ...
      -> java.security.spec                                 
      -> java.util                                          
/Library/Java/JavaVirtualMachines/jdkjdk/Contents/Home/jre/lib/rt.jar -> /Library/Java/JavaVirtualMachines/jdkjdk/Contents/Home/jre/lib/jce.jar
