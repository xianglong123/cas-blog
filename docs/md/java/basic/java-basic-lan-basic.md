...
![img.png](images/P342UBi0mIBuvLwr.png)
...
> StackOverflow : Why dont Javas +=, -=, *=, /= compound assignment operators require casting?在新窗口打开
...
> StackOverflow : Why cant your switch statement data type be long, Java?在新窗口打开
...
System.out.println(eequals(e2)); // true
...
// CloneExample e2 = eclone(); // 'clone()' has protected access in 'java.lang.Object'
```
...
> ![img.png](images/HuVNXPF7yWiNp9W4.png)
